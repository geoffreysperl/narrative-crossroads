...
Narrative Crossroads supports multiple Michigan ELA standards. This page provides explicit mappings to help educators justify implementation and document standards coverage.
...
| Standard | What It Requires | How NC Addresses It |
|:---------|:-----------------|:--------------------|
| **L.8.3** | Use knowledge of language and its conventions when writing, speaking, reading, or listening | Register shifting between character voice and analytical discussion develops language flexibility |
| **L.9-10.3** | Apply knowledge of language to understand how language functions in different contexts | Character voice vs. debrief voice demonstrates context-dependent language use |
...
The codes above are Michigan Academic Standards for ELA (adopted from the Common Core State Standards in 2010), so they apply directly. Additionally, Narrative Crossroads supports Michigan's **Social-Emotional Learning Competencies**:
...
Key points:
- **Standards-aligned** — Explicit connections to Michigan ELA standards for Reading, Writing, Speaking/Listening, and Language
- **Assessment-ready** — Multiple formative and summative assessment options with clear rubric criteria
- **Research-supported** — See [Why It Works]({% link method/why-it-works.md %}) for evidence base
- **Differentiated** — Built-in scaffolding for multilingual learners; see [ML Scaffolding]({% link method/ml-scaffolding.md %})

Questions? Contact [geoffrey@geoffreysperl.com](mailto:geoffrey@geoffreysperl.com)
