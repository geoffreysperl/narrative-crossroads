...
Nonprofit using TTRPGs for social-emotional learning, particularly with neurodiverse youth. Different focus from Narrative Crossroads but valuable allied work.
...
### Gen Con Trade Day
[gencon.com](https://www.gencon.com/)

Annual Trade Day programming includes educator sessions. Major networking opportunity for TTRPG education community.
...
- **Classcraft** — Gamification platform with RPG elements (not a TTRPG but related)
- **Mythic** — GM emulator useful for solo or small group play
...
- Bowman, S. L. (2010). *The Functions of Role-Playing Games*. McFarland.
...
- TabletopEDU Discord (see their website for invite)
- Various game-specific education channels

### Social Media

- #TTRPGEducation on Twitter/X
- Facebook groups for TTRPG educators
...
- [Roll20](https://roll20.net) — Free tier available; widely used
- [Foundry VTT](https://foundryvtt.com) — One-time purchase; highly customizable
- [Owlbear Rodeo](https://www.owlbear.rodeo) — Simple, free, no account required

### Character Sheet Tools

- [D&D Beyond](https://www.dndbeyond.com) — Digital character sheets (D&D-specific)
- Google Sheets templates (various creators)

### Mapping

- [Dungeondraft](https://dungeondraft.net) — Map creation
- [Inkarnate](https://inkarnate.com) — Fantasy maps
...
*Have a resource to suggest? Contact [geoffrey@geoffreysperl.com](mailto:geoffrey@geoffreysperl.com)*
